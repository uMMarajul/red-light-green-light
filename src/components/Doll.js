...
class Doll {
    constructor(name = "Doll", onLoadCallback) {
        ...
        this.rotationToggle = true; // Start with 360°
        this.lastRotationTime = 0; // Track the last time rotation occurred
        this.rotationSpeed = 10; // Speed to smoothly rotate to the target angle
    }

    loadModel() {
        this.loader.load('../assets/doll.glb',  (gltf) => {
